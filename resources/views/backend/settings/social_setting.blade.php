	...
	<div class="card">
		<div class="card-body">
			<div class="form-group mb-2">
				...
				<textarea class="form-control" name="facebook_script"></textarea>
			</div>
			<div class="form-check form-switch mb-2">
                <input type="checkbox" class="form-check-input" id="facebookscript" name="facebook_published" value="yes">
	...
	<div class="card">
		<div class="card-body">
			<div class="form-group mb-2">
				...
				<textarea class="form-control" name="whatsapp_script"></textarea>
			</div>
			<div class="form-check form-switch mb-2">
                <input type="checkbox" class="form-check-input" id="whatsappscript" name="whatsapp_published" value="yes">
